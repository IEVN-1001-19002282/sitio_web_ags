      ...
      <div class="d-flex align-center">
        <router-link to="/">
          <v-img
            ...
            src="@/assets/LogoUTL_Blanco.webp"
    ...
    <v-row justify="center">
      ...
      <!--IMAGENES DE FONDO-->
        <v-card color="#00FF0000">
          ...
          dialog_soy_estudiante == true && sub_menu_soy_aspirante == true ? require('@/assets/fondos/fondo_aspirante.webp') :
          dialog_soy_estudiante == true && sub_menu_soy_estudiante == true ? require('@/assets/fondos/oferta.webp') :
          dialog_soy_estudiante == true && sub_menu_soy_docente == true ? require('@/assets/fondos/fondo_tramites.webp') :
          require('@/assets/fondos/FondoMenuPrincipal.webp')"
